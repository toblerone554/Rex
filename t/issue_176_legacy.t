...
ok($con_hash_t3{auth_type} eq "try", "legacy test - got auth_type try for t3");
...
ok($con_hash_t4{auth_type} eq "try", "legacy test - got auth_type try for t4");
...
ok($con_hash_t5{auth_type} eq "try", "legacy test - got auth_type try for t5");
