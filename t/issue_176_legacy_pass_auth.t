...
ok($con_hash_t3{auth_type} eq "pass", "legacy test - got auth_type pass for t3");
...
ok($con_hash_t4{auth_type} eq "pass", "legacy test - got auth_type pass for t4");
...
ok($con_hash_t5{auth_type} eq "pass", "legacy test - got auth_type pass for t5");
